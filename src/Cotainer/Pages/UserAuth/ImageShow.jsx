...
export function ImageCarousel({ currentStep }) {
  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center overflow-hidden rounded-lg mask-radial-[100%_100%] mask-radial-from-95% mask-radial-at-left  rounded-lg">
